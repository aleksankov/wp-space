...
if ($home_hero_title):
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-section__wrap" data-hero-video
                ...
                <!--            <source src="--><?php //= $home_hero_video;
                ?><!--" type="video/mp4">-->
                <!--        </video>-->
                <!--    </div>-->
                <?php //endif;
                ...
                <div class="hero-section__img" data-aos="zoom-in">
                    <div class="hero-section__video">
                        ...
                        ?><!--/assets/img/hero-video-preview.png" alt="">-->
                    </div>
                </div>
                        ...
                        <?php if ($home_hero_btn): ?>
                            <div class="hero-section__btn">
                                <a class="btn" href="#demo-popup" data-fancybox=""
                                   data-touch="false"><?= $home_hero_btn; ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
                    <?php if ($home_hero_awards): ?>
                        <div class="hero-section__bottom" data-aos="fade" data-aos-delay="200">
                            <div class="hero-section__row">
                                <?php $counter = 1;
                                foreach ($home_hero_awards as $home_hero_award): if ($home_hero_award['icon'] || $home_hero_award['desc']): ?>
        ...
        <div class="container">
            ...
            <div class="home-products__slider swiper-container">
                <div class="swiper-wrapper">
                    <?php $counter = 0;
                    foreach ($home_products_items as $home_products_item): ?>
                        <div class="home-products__slide swiper-slide" data-aos="fade-up"
                             data-aos-delay="<?= $counter * 200; ?>">
                            <a class="product-card" href="<?= $home_products_item['url']; ?>">
                                <div class="product-card__bg">
                                    <img src="<?= $home_products_item['bg']; ?>"
                                         alt="<?= $home_products_item['label']; ?>">
                                </div>
                                ...
                                <h3 class="product-card__title">
                                    ...
                                    <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                                        ...
                                        <path d="M23 33L33 23M33 23H23M33 23V33"
                                              stroke="<?= $home_products_item['color']; ?>" stroke-width="2"
    ...
    <section class="home-why section">
        <div class="container">
            ...
            <div class="home-why__row row">
                <?php $counter = 1;
                foreach ($home_why_items as $home_why_item): ?>
                    <div class="home-why__col col"
                         data-aos="fade-up"<?= $counter % 2 ? '' : ' data-aos-delay="200"'; ?>>
                        <div class="home-why__item">
                            <div class="home-why__item-bg">
                                <img src="<?= kama_thumb_src('wh=1184:720', $home_why_item['img']); ?>"
                                     alt="<?= $home_why_title; ?> - BG <?= $counter; ?>">
                            </div>
...
if ($home_gallery_images):
    ...
    <section class="home-gallery section">
        ...
        <div class="home-gallery__slider swiper-container" data-aos="fade-up">
            <div class="swiper-wrapper">
                <?php $counter = 1;
                foreach ($home_gallery_images as $home_gallery_image): ?>
                    <div class="home-gallery__slide swiper-slide">
                        <div class="home-gallery__item">
                            <img src="<?= kama_thumb_src('wh=1168:776', $home_gallery_image); ?>"
            ...
            <div class="home-technologies__wrap row-lg">
                <div class="home-technologies__left col-lg" data-aos="fade-up">
                    <div class="home-technologies__tabs js-h-technologies-tabs">
                        <?php $counter = 1;
                        foreach ($home_tech_items as $home_tech_item): ?>
                                        ...
                                        <div class="home-technologies__tab-content">
                                            ...
                                            <div class="home-technologies__tab-bottom">
                                                ...
                                                <?php if ($home_tech_item['url']): ?>
                                                    <a class="home-technologies__tab-btn"
                                                       href="<?= $home_tech_item['url']; ?>" target="_blank">
                                                        <span>Подробнее</span>
                        ...
                        foreach ($home_tech_items as $home_tech_item): ?>
                            <div class="home-technologies__col">
                                <div class="home-technologies__item">
                                    <button class="home-technologies__item-tab-btn h7 js-h-technologies-tab-btn<?= $counter == 1 ? ' active' : ''; ?>"
                                            type="button"><?= $home_tech_item['title']; ?></button>
                                </div>
                            </div>
                            <?php $counter++; endforeach; ?>
                    </div>
                        ...
                        <?php if ($home_banner_btn_label && $home_banner_btn_url): ?>
                            <div class="home-connect__btn">
                                <a class="btn btn-white"
                                   href="<?= $home_banner_btn_url; ?>"><?= $home_banner_btn_label; ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <?php if ($home_regions_cards): ?>
                        <div class="home-regions__left col-lg" data-aos="fade-up">
                            <div class="home-regions__items">
                                <?php $counter = 1;
                                foreach ($home_regions_cards as $home_regions_card): ?>
                                    <div class="home-regions__item">
                                        <?php if ($home_regions_card['icon']): ?>
                                            <div class="home-regions__item-icon">
                                                <img src="<?= $home_regions_card['icon']; ?>"
                                                     alt="<?= $home_regions_title; ?> - Icon <?= $counter; ?>">
                                            </div>
                                        <?php endif; ?>
                            ...
                            <?php foreach ($home_regions_items as $home_regions_item): ?>
                                <div class="home-regions__card">
                                    <div class="home-regions__card-bg">
                                        <img src="<?= kama_thumb_src('wh=444:258', $home_regions_item['img']); ?>"
                                             alt="<?= $home_regions_item['city']; ?>">
                                    </div>
...
$home_demo_fallback_socials = array_filter([
    [
        'url' => $site_soc_yt,
        'text' => $home_demo_desc_yt,
    ],
    [
        'url' => $site_soc_rutube,
        'text' => $home_demo_desc_rutube,
    ],
    [
        'url' => $site_soc_tg,
        'text' => $home_demo_desc_tg,
    ],
    [
        'url' => $site_soc_habr,
        'text' => $home_demo_desc_habr,
    ],
], static function ($social) {
    return !empty($social['url']) && !empty($social['text']);
});

$home_demo_social_rows = get_field('home_demo_socials');
$home_demo_socials = [];

if (is_array($home_demo_social_rows)) {
    foreach ($home_demo_social_rows as $home_demo_social_row) {
        $home_demo_social_url = isset($home_demo_social_row['url']) ? trim($home_demo_social_row['url']) : '';
        $home_demo_social_text = isset($home_demo_social_row['text']) ? trim($home_demo_social_row['text']) : '';

        if (!$home_demo_social_url || !$home_demo_social_text) {
            continue;
        }

        $home_demo_social_icon = $home_demo_social_row['icon'] ?? 0;
        $home_demo_social_icon_id = is_array($home_demo_social_icon)
            ? absint($home_demo_social_icon['ID'] ?? $home_demo_social_icon['id'] ?? 0)
            : absint($home_demo_social_icon);

        $home_demo_social_bg = $home_demo_social_row['bg'] ?? 0;
        $home_demo_social_bg_id = is_array($home_demo_social_bg)
            ? absint($home_demo_social_bg['ID'] ?? $home_demo_social_bg['id'] ?? 0)
            : absint($home_demo_social_bg);

        $home_demo_socials[] = [
            'url' => $home_demo_social_url,
            'text' => $home_demo_social_text,
            'icon_id' => $home_demo_social_icon_id,
            'bg_id' => $home_demo_social_bg_id,
        ];
    }
} elseif (!empty($home_demo_social_rows) && defined('WP_DEBUG') && WP_DEBUG) {
    error_log('[homepage.demo.socials] Expected home_demo_socials to be an array.');
}

$home_demo_has_managed_socials = !empty($home_demo_socials);
$home_demo_has_socials = $home_demo_has_managed_socials || !empty($home_demo_fallback_socials);
?>
    <section class="demo section">
        ...
        <div class="container">
            <div class="demo__row row-lg">
                <div class="demo__left col-lg<?= !$home_demo_has_socials ? ' demo__left--wide' : ''; ?>" data-aos="fade-up">
                    <form class="demo__form ajax-wrap js-form">
                        <?php if (!empty($home_regions_title)): ?>
                ...
                <?php if ($home_demo_has_socials): ?>
                <div class="demo__right col-lg" data-aos="fade-up" data-aos-delay="200">
                    <div class="demo__soc">
                        <?php if ($home_demo_has_managed_socials): ?>
                            <?php foreach ($home_demo_socials as $home_demo_social): ?>
                                <div class="demo__soc-col">
                                    <a class="demo__soc-item" href="<?= esc_url($home_demo_social['url']); ?>" target="_blank" rel="noopener noreferrer">
                                        <?php if ($home_demo_social['icon_id']): ?>
                                            <?php
                                            $home_demo_social_icon = wp_get_attachment_image($home_demo_social['icon_id'], 'full', false, [
                                                'alt' => $home_demo_social['text'],
                                                'class' => 'demo__soc-icon'
                                            ]);

                                            if ($home_demo_social_icon) {
                                                echo $home_demo_social_icon;
                                            }
                                            ?>
                                        <?php endif; ?>
                                        <span>
                                            <?php if ($home_demo_social['bg_id']): ?>
                                                <?php
                                                $home_demo_social_bg = wp_get_attachment_image($home_demo_social['bg_id'], 'full', false, [
                                                    'alt' => $home_demo_social['text'],
                                                ]);

                                                if ($home_demo_social_bg) {
                                                    echo $home_demo_social_bg;
                                                } elseif (defined('WP_DEBUG') && WP_DEBUG) {
                                                    error_log('[homepage.demo.socials] Invalid social background attachment ID.');
                                                }
                                                ?>
                                            <?php endif; ?>
                                            <span><?= esc_html($home_demo_social['text']); ?></span>
                                            <i>
                        ...
                        <?php if ($site_soc_yt && $home_demo_desc_yt): ?>
                            <div class="demo__soc-col">
                                <a class="demo__soc-item" href="<?= esc_url($site_soc_yt); ?>" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <span>
                                        <img src="<?= get_template_directory_uri(); ?>/assets/img/demo-soc-icon-1.svg"
                                             alt="Youtube">
                                        <span><?= esc_html($home_demo_desc_yt); ?></span>
                                        <i>
                        ...
                        <?php if ($site_soc_rutube && $home_demo_desc_rutube): ?>
                            <div class="demo__soc-col">
                                <a class="demo__soc-item" href="<?= esc_url($site_soc_rutube); ?>" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <span>
                                        <img src="<?= get_template_directory_uri(); ?>/assets/img/demo-soc-icon-2.svg"
                                             alt="Rutube">
                                        <span><?= esc_html($home_demo_desc_rutube); ?></span>
                                        <i>
                                            <img src="<?= get_template_directory_uri(); ?>/assets/img/soc-arrow.svg"
                                                 alt="Rutube">
                                        </i>
                        ...
                        <?php if ($site_soc_tg && $home_demo_desc_tg): ?>
                            <div class="demo__soc-col">
                                <a class="demo__soc-item" href="<?= esc_url($site_soc_tg); ?>" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <span>
                                        <img src="<?= get_template_directory_uri(); ?>/assets/img/demo-soc-icon-3.svg"
                                             alt="Telegram">
                                        <span><?= esc_html($home_demo_desc_tg); ?></span>
                                        <i>
                                            <img src="<?= get_template_directory_uri(); ?>/assets/img/soc-arrow.svg"
                                                 alt="Telegram">
                                        </i>
                        ...
                        <?php if ($site_soc_habr && $home_demo_desc_habr): ?>
                            <div class="demo__soc-col">
                                <a class="demo__soc-item" href="<?= esc_url($site_soc_habr); ?>" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <span>
                                        <img src="<?= get_template_directory_uri(); ?>/assets/img/demo-soc-icon-4.svg"
                                             alt="Habr">
                                        <span><?= esc_html($home_demo_desc_habr); ?></span>
                                        <i>
                                            <img src="<?= get_template_directory_uri(); ?>/assets/img/soc-arrow.svg"
                                                 alt="Habr">
                                        </i>
    ...
    <section class="home-portfolio section">
        <div class="container">
                            ...
                            <?php foreach ($home_portfolio_items as $home_portfolio_item): ?>
                                <div class="home-portfolio__item">
                                    <?php if ($home_portfolio_item['icon']): ?>
                                        <img src="<?= $home_portfolio_item['icon']; ?>"
                                             alt="<?= $home_portfolio_item['label']; ?>">
                                    <?php endif; ?>
                ...
                <?php if ($home_portfolio_gallery_cols): ?>
                    <div class="home-portfolio__right home-portfolio__col" data-aos="fade-up">
                        <div class="home-portfolio__lists">
                            <?php $counter = 1;
                            foreach ($home_portfolio_gallery_cols as $home_portfolio_gallery_col): ?>
                                <div class="home-portfolio__list js-infinity-line"
                                     data-duration="15"<?= $counter == 1 ? ' data-revers="1"' : ''; ?>>
                                    <?php $logo_counter = 1;
                                    foreach ($home_portfolio_gallery_col as $home_portfolio_gallery_item): ?>
                                        <div class="home-portfolio__logo">
                                            <img src="<?= kama_thumb_src('wh=548:278', $home_portfolio_gallery_item); ?>"
                                                 alt="<?= $home_portfolio_sub; ?> - Logo <?= $logo_counter; ?>">
                                        </div>
            ...
            <div class="home-portfolio__slider swiper-container" data-aos="fade-up">
                <div class="swiper-wrapper">
                    <?php $logo_counter = 1;
                    foreach ($home_portfolio_gallery as $home_portfolio_gallery_item): ?>
    ...
    <section class="home-product-video section">
        <div class="container">
            <div class="home-product-video__tabs" data-aos="fade-up">
                <?php $counter = 1;
                foreach ($home_video_items as $home_video_item): ?>
                    <button class="home-product-video__tab js-h-product-video-tab<?= $counter == 1 ? ' active' : ''; ?>"
                            type="button"><?= $home_video_item['label']; ?></button>
                    <?php $counter++; endforeach; ?>
            </div>
                    ...
                    <div class="home-product-video__block js-h-product-video-block"<?= $counter == 1 ? ' style="display: block;"' : ''; ?>>
                        <div class="home-product-video__item js-h-product-video-item">
                            ...
                            <div class="home-product-video__item-bg">
                                <img src="<?= kama_thumb_src('wh=1200:648', $home_video_item['bg']); ?>"
                                     alt="<?= $home_video_item['label']; ?>">
    ...
    <section class="home-media section">
        <div class="container">
            ...
            <div class="home-media__slider swiper-container">
                <div class="swiper-wrapper">
                    <?php $counter = 1;
                    foreach ($home_media_items as $home_media_item): ?>
                        <div class="home-media__slide swiper-slide" data-aos="fade-up"
