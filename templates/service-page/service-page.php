...
виртуальную ИТ-инфраструктуру',
  ...
  'service_callout_btn_url' => '#demo-popup',
  'service_callout_anim_enabled' => true,
  'service_callout_anim_delay' => 200,
...
$service_get_callout_field = static function ($field_name) use ($service_default_fields, $service_field_has_value, $service_debug_log) {
    ...
    if ('service_callout_anim_enabled' === $field_name && $post_id && metadata_exists('post', $post_id, $field_name)) {
        return (bool) $service_value;
    }
